      ...
      if (p.commits) {
        ...
        p.commits.forEach(function(d, i) {
          ...
          if (i < 2) {
            ...
            d.committerGravatar = Mustache.render('<img class="gha-gravatar-commit" src="./assets/plugins/github-activity/img/gravatar-user-420.png" width="16" />', { hash: md5(d.author.email) });
          } else {
...
var templates = {
  ...
  Footer: '<div class="gha-footer">Public Activity <a href="https://github.com" target="_blank">GitHub</a>',
